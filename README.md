...
싱글모드는 혼자, 멀티모드는 최대 4인의<br> 유저들과 화상, 채팅으로 소통하며 게임을 즐길 수 있습니다.
    ...
    <td align="center"> <img src="https://user-images.githubusercontent.com/63646254/108621920-034a5500-7479-11eb-8f94-348ba844673f.png" alt="2" width="444" height="265">
      <br>
      유저는 3가지 캐릭터 중 하나를 선택해 플레이할 수 있습니다. <br>
      한번 선택한 캐릭터는 바꿀 수 없습니다.
      <br>
      <br>
    </td>
   </tr> 
...
새로운 스택에 대해 걱정이 많았던 터라 본격적으로 개발을 시작했을 때 새로운 스택을 사용하는 부분에서 어려움을 겪을 거라 예상했는데, 기존 스택을 사용하는 것부터 진도가 나가지 않아 힘겨웠던 기억이 있습니다. React 및 React-Hooks와 Redux로 페이지 구현, 상태 관리를 하면서 ’이 정도는 쉽게 하지 않을까’라고 생각했던 부분에서 막혔고, 이번 프로젝트에 도입하게 된 Typescript를 사용함에서도 Javascript와 조금씩 다른 문법에 에러 핸들링으로 소비하는 시간이 많았습니다.
제 할당량을 하지 못한 것 같아 프로젝트 중반에 개발 속도를 높이기 위해서 팀원들의 도움을 받았는데, 개발 이슈로 서로 어려움을 겪고 있는 부분에 대해 공유하고 함께 해결하는 과정에서 팀워크의 중요성을 배웠으며, 기술뿐만 아니라 팀원들과의 소통도 중요하다는 것을 많이 느꼈습니다.
이러한 경험이 있었기에 내 실력을 객관적으로 파악하여 문제를 해결할 수 있었고 어떻게 해야 내 의견을 더욱더 잘 전달할 수 있을지, 그리고 모든 팀원이 만족하는 결과물을 낼지 등 팀원들과의 오버 커뮤니케이션으로 프로젝트를 잘 마무리할 수 있었다고 생각합니다.
