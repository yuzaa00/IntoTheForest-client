...
export default class Boot extends Phaser.Scene { // resource load scene
  ...
  preload(): void {
    ...
    this.load.spritesheet('dog3', 'https://elb.intotheforest.space/dog2-500.png', { frameWidth: 500, frameHeight: 500 })
    this.load.spritesheet('dog2', 'https://elb.intotheforest.space/white-dog-2.png', { frameWidth: 500, frameHeight: 500 })

    // this.load.spritesheet('dog2', 'https://elb.intotheforest.space/dog2-running-test.png', { frameWidth: 220, frameHeight: 220})
    
    //background load
    this.load.image('forestLogo', 'https://elb.intotheforest.space/forestLogo.png')
