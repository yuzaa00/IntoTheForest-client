...
export default class Stage2 extends Phaser.Scene {
  ...
  private enemiesTimer: Array<number> = [4, 4, 5, 5, 6, 6, 7, 7, 6, 6]
  ...
  public create(): void {
    ...
    this.skyTile = this.add // 백그라운드 배경
      .tileSprite(0, 0, 30000, 600, 'stage2')
      .setScrollFactor(0)
      .setOrigin(0)
      .setDepth(0)
    ...
    this.player = this.physics.add
      .sprite(28500, 200, this.registry.values.char) // 플레이어 생성 이동
      .setScale(0.25)
      .setDepth(3)
  ...
  collectSignExit(player: any, tile: any): void { // 오브젝트 간 충돌 이벤트, 다음 스테이지로
